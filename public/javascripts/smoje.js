                            ...
                            success: function (data2) {
                                ...
                                for (var i = 0; i < data2.length; i++) {
                                    if (data2[i].deviceID === tracker.deviceID) {
                                        ...
                                        var trackerPoint2 = new google.maps.LatLng(tracker2.lastPosition.latitude, tracker2.lastPosition.longitude)

                                        marker.setPosition(trackerPoint2);
                                        //map.setCenter(trackerPoint2);
                                        //map.setZoom(14);
